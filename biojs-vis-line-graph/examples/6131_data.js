...
6]],
	...
	tip_decoy: tip,
        ...
        radius: 3,
        sort_by_sample_id: "yes",
        sample_id_order: "none",
        ...
        legend_rect_size: 20,
        height: 400,
        legend_list: probes_types,//Select the list you want on the legend (i.e. sample_id_list)
        ...
        box_width: 50,
        box_width_wiskers: 5,
        day_state_order: "none", //Order of the day state on the x axis
